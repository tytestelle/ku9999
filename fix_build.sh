#!/bin/bash
# fix_build.sh - 最终资源修复（强制使用系统图标，创建 drawable）
set -e

echo "=========================================="
echo "  🔧 修复资源错误（ic_launcher_foreground）"
echo "=========================================="
...
# ---------- 2. 同时创建 drawable/ic_launcher_foreground.xml（以防其他文件引用） ----------
...
# ---------- 3. 其他必要修复（build.gradle 等，但之前已做，此处确保） ----------
