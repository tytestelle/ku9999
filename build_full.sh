...
# 其他图标（使用简单形状）
for icon in channels epg settings add favorite favorite_border refresh channel_placeholder; do
    case $icon in
...
echo "  - 播放（ExoPlayer，HLS，解码切换，比例）"
echo "  - EPG节目单（XMLTV，7天回看，时移）"
echo "  - 分组显示，二级分组，搜索，台标，收藏"
echo "  - JS脚本，Headers，Host，远程输入，断线重连（UI及框架）"
